  ...
  head: () => ({
    meta: [
      ...
      { title: "EcoShopper — Shop Smarter, Shop Greener" },
      {
        name: "description",
        content:
          "Search products, see sustainability ratings and find eco-friendly alternatives with recycling guidance.",
      },
      { name: "author", content: "EcoShopper" },
      { property: "og:title", content: "EcoShopper — Shop Smarter, Shop Greener" },
      {
        property: "og:description",
        content: "Sustainability ratings and greener alternatives for everyday products.",
      },
